...
% 833*2 - 4.91925
% 4033*2 - 4.92589
% err_a2 = abs([4.88648,4.91409,4.91925,4.92589]-4.92747)/4.92747; dof_a2 = [133,481,833,4033]*2; polyfit(log(dof_a2),log(err_a2),1)
...
Corresponding meshes are plotted in %fig.~\ref{}
\begin{figure}[h!]
    \centering
