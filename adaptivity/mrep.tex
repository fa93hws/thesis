...
The procedure of constructing the matrix representation for NURBS curves are explained detail in \cite{Laurent2014}.
\paragraph{}
...
The calculation of the intersection is described in detail in \cite{Buse2010, Ba2009}.
