...
The left and bottom boundary are enforced with a roller boundary condition. $u_x=0$ where $y=0$ and $u_y=0$ where $x=0$.
...
Another unique feature of the proposed method is that the method allows mixed type or order of shape functions to be employed for each line segment.
